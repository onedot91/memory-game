...
export const WEAPONS: Array<{ id: WeaponId; name: string; label: string; description: string; color: string }> = [
  { id: 'pistol', name: '기억 권총', label: '균형', description: '한 대상에게 피해 6', color: '#e8c477' },
  { id: 'rifle', name: '관통 소총', label: '관통', description: '주 대상 5 · 다음 대상 3', color: '#9ec6c5' },
  { id: 'tesla', name: '연쇄 전기총', label: '연쇄', description: '세 대상에게 피해 4 · 2 · 2', color: '#91c6ee' },
  { id: 'shotgun', name: '파편 산탄총', label: '확산', description: '주 대상 5 · 나머지 각 1', color: '#e9a276' },
  { id: 'cannon', name: '공명 대포', label: '충전', description: '정답 두 번마다 피해 14', color: '#c3a1ef' },
  { id: 'wand', name: '수호 완드', label: '보호', description: '피해 4 · 정답 세 번마다 보호막 1', color: '#95d4a8' },
];
